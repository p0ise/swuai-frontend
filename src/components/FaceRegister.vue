    ...
    <div class="login-box">
      ...
      <form @submit.prevent="" class="login-form">
        ...
        <v-row class="justify-center">
          <v-col class="d-flex justify-center" style="max-width: 525px;">
            ...
            <v-snackbar v-model="snackbar" vertical color="success" class="snackbar-center">
              <div class="text-subtitle-1 pb-2">注册成功！</div>
        ...
        <div class="input-group">
          <input v-model="name" type="text" required autofocus placeholder="用户名" />
          <span class="bar"></span>
        </div>
...
.input-group {
  position: relative;
  margin: 0 auto; /* 修改此处以居中整个组件 */
  width: 80%; /* 定义输入组宽度，也可以根据实际需要调整 */
  margin-bottom: 15px;
  text-align: center; /* 添加此属性以确保内部内容居中，针对placeholder */
}
